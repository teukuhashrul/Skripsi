...
\usepackage{amsmath} % untuk label equation 
% untuk supaya paragraf dapat dicustom sebagai mempunyai nomor bab dibawah subsection
%\usepackage{titlesec}
%\setcounter{secnumdepth}{4}

% library dibawah buat masukin source code 
\usepackage{listings}
\usepackage{color}

% setting kode sesuai lampiran kode
\lstset{
numbers=left,stepnumber=1, numbersep=5pt, frame=leftline,
...
% Library untuk mengatur size table dilatex 
...
\iftoggle{develop}{ 
	...
	\prakata{Skripsi ini saya persembahkan kepada ibunda dan almarhum ayahanda saya \ldots}
